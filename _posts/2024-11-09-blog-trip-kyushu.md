...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6189.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6193.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm-10 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6200.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm-10 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6307.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6215.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/postcard.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6349.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6345.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-6">
        <div class="photo-container mt-3 "  style="height: 500px;">
            {% include figure.html path="assets/img/japan/kyushu/IMG_6381.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    <div class="caption">
    ...
    <div class="col-sm-6">
        <div class="photo-container " style="height: 280px;">
            {% include figure.html path="assets/img/japan/kyushu/IMG_6387.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container mt-1 "  style="height: 300px;">
            {% include figure.html path="assets/img/japan/kyushu/IMG_6383.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6371.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6376.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="col-sm-12">
    ...
    {% include figure.html path="assets/img/japan/kyushu/xidashan.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm-5">
        ...
        {% include figure.html path="assets/img/japan/kyushu/IMG_6399.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
        </div>
    </div>
    <div class="col-sm-7">
        <div class="photo-container mt-3 " style="height: 230px;" >
        {% include figure.html path="assets/img/japan/kyushu/IMG_6427.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption">
...
<div class="col-sm-4">
    ...
    {% include figure.html path="assets/img/japan/kyushu/IMG_6540.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="col-sm-8">
    <div class="photo-container " style="height: 378px;" >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6533.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm-6">
        ...
        {% include figure.html path="assets/img/japan/kyushu/IMG_6466.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
        </div>
    </div>
    <div class="col-sm-6">
        <div class="photo-container " >
        {% include figure.html path="assets/img/japan/kyushu/IMG_6511.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption">
...
<div class="col-sm-5" style="float: right;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6572.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
...
<div class="col-sm-4 mt-md-0" style="margin-left:auto">
    ...
    {% include figure.html path="assets/img/japan/kyushu/IMG_6576.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="col-sm-7 mt-md-0" style="margin-right:auto">
    <div class="photo-container " style="height: 300px;" >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6637.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
<div class="caption">
...
<div class="col-sm-12" style="margin-bottom: -1rem">
    <div class="col-sm-12 " >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6692.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-6">
        <div class="photo-container "  style="height: 450px;">
            {% include figure.html path="assets/img/japan/kyushu/IMG_6674.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    <div class="caption">
    ...
    <div class="col-sm-6">
        <div class="photo-container " >
            {% include figure.html path="assets/img/japan/kyushu/IMG_6678.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container mt-1 "  >
            {% include figure.html path="assets/img/japan/kyushu/IMG_6712.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="col-sm-4" style="float: right;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6729.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.5rem; margin-bottom:0">
...
<div class="col-sm-4 mt-md-0" style="margin-left:auto">
    ...
    {% include figure.html path="assets/img/japan/kyushu/IMG_6752.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="col-sm-7 mt-md-0" style="margin-right:auto">
    <div class="photo-container " style="height: 320px;" >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6745.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
<div class="caption" style="margin-top: 0.5rem;">
...
<div class="col-sm-12" style="margin-bottom: -1rem">
    ...
    {% include figure.html path="assets/img/japan/kyushu/IMG_6780.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
<div class="caption" style="margin-top: -0.5rem">
...
<div class="col-sm-4" style="float: left;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6787.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-9 mt-3">
        <div class="photo-container "  >
            {% include figure.html path="assets/img/japan/kyushu/IMG_6796.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    ...
    <div class="col-sm-3">
        <div class="photo-container " >
            {% include figure.html path="assets/img/japan/kyushu/TomatoMe.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container mt-2 "  >
            {% include figure.html path="assets/img/japan/kyushu/IMG_6809.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="col-sm-8" style="float: left;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kyushu/IMG_6825.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
...
<div class="row mt-3">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6837.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kyushu/IMG_6849.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="col-sm-9" style="float: right;">
    <div class="row">
        <div class="col-sm-6 mt-md-0" style="margin-left: 0; margin-right: 0">
            <div class="photo-container"  >
            {% include figure.html path="assets/img/japan/kyushu/IMG_6878.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
        <div class="col-sm-6 mt-md-0" style="margin-left: auto; margin-right: 0">
            <div class="photo-container" >
            {% include figure.html path="assets/img/japan/kyushu/IMG_6881.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
    </div>
