...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6189.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6193.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm-10 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6200.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm-10 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6307.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6215.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/postcard.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6349.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6345.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-6">
        <div class="photo-container mt-3 "  style="height: 500px;">
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6381.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    <div class="caption">
    ...
    <div class="col-sm-6">
        <div class="photo-container " style="height: 280px;">
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6387.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container mt-1 "  style="height: 300px;">
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6383.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6371.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6376.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="col-sm-12">
    <div class="col-sm-12 mt-1"  style="display:block; margin-left:auto; margin-right:auto">
    {% include figure.liquid path="assets/img/japan/kyushu/xidashan.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>

<div class="row mt-3">
    <div class="col-sm-5">
        <div class="photo-container mt-3 " style="height: 240px;" >
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6399.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
        </div>
    </div>
    <div class="col-sm-7">
        <div class="photo-container mt-3 " style="height: 230px;" >
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6427.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption">
    [Top] Me at the southernmost JR station in Japan.<br>
...
The view at Cape NagasakiBana was absolutely stunning! I met two Austrian travelers (Jacob and Mani) here, and we had a great conversation, though we lost track of time:) 
So when we were ready to head back, it had already gotten dark. Since my bicycle didn’t have lights, it was quite dangerous for me to go back alone. Fortunately, they decided to help me and offered to drive me with my bike back to the hostel !!!



<div class="row mt-3 mb-2">
<div class="col-sm-4">
    <div class="photo-container " style="height: 378px;" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6540.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="col-sm-8">
    <div class="photo-container " style="height: 378px;" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6533.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm-6">
        ...
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6466.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
        </div>
    </div>
    <div class="col-sm-6">
        <div class="photo-container " >
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6511.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption">
    [Left] Beautiful NagasakiBana with two contrast views of the sea. <br>[Right] Me in front of the Kaimondake Valcano 開聞岳 (where I will climb tomorrow).
</div>
...
<div class="col-sm-5" style="float: right;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6572.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
...
[//]: # (I woke up early and rushed to catch the train. The guesthouse owner in Ibusuki, Yoko-san, was very kind and drove me to the train station.)


<div class="row mt-3 mb-2">
<div class="col-sm-4 mt-md-0" style="margin-left:auto">
    <div class="photo-container " style="height: 300px;" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6576.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="col-sm-7 mt-md-0" style="margin-right:auto">
    <div class="photo-container " style="height: 300px;" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6637.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
<div class="caption">
...
<div class="col-sm-12" style="margin-bottom: -1rem">
    <div class="col-sm-12 " >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6692.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-6">
        <div class="photo-container "  style="height: 450px;">
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6674.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    <div class="caption">
    ...
    <div class="col-sm-6">
        <div class="photo-container " >
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6678.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container mt-1 "  >
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6712.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="col-sm-4" style="float: right;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6729.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.5rem; margin-bottom:0">
...
<div class="row mt-3">
<div class="col-sm-4 mt-md-0" style="margin-left:auto">
    <div class="photo-container " style="height: 320px;" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6752.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
<div class="col-sm-7 mt-md-0" style="margin-right:auto">
    <div class="photo-container " style="height: 320px;" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6745.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
<div class="caption" style="margin-top: 0.5rem;">
...
<div class="col-sm-12" style="margin-bottom: -1rem">
    ...
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6780.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
<div class="caption" style="margin-top: -0.5rem">
...
<div class="col-sm-4" style="float: left;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6787.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
</div>
At 9 AM, I took a bus from Unzen to Nagasaki. Fortunately, I found a decent hostel again after two nights of poor sleep, during which I felt completely worn out.
...
<div class="row mt-3 justify-content-center">
    <div class="col-sm-9 mt-3">
        <div class="photo-container "  >
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6796.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    <div class="caption" style="margin-top: -0.3rem;" >
        [Upper] Me and Alison in front of the bridge [Right] Tomato Ramen moment.
    </div>
    </div>
    <div class="col-sm-3">
        <div class="photo-container " >
            {% include figure.liquid path="assets/img/japan/kyushu/TomatoMe.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container mt-2 "  >
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6809.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="col-sm-8" style="float: left;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kyushu/IMG_6825.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.3rem; margin-bottom: -0.3rem;">
...
<br>Sadly, I missed the bus again and ended up waiting for a long time. It seems my timing still needs work!


<div class="row mt-3">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6837.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kyushu/IMG_6849.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="col-sm-9" style="float: right;">
    <div class="row">
        <div class="col-sm-6 mt-md-0" style="margin-left: 0; margin-right: 0">
            <div class="photo-container"  >
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6878.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
        <div class="col-sm-6 mt-md-0" style="margin-left: auto; margin-right: 0">
            <div class="photo-container" >
            {% include figure.liquid path="assets/img/japan/kyushu/IMG_6881.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
    </div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom: 0.1rem;">
...
After touring the area, I coincidentally ran into Lior again! **He joked that I had put a GPS in his bag to track him down :)**
He recommended a nearby Chinese restaurant, which was quite good. There was also a young child at the restaurant serving tea, probably the owner's child.
In the afternoon, I took a train to Fukuoka Airport and arrived in Osaka at 10 PM!