...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/okinawa/IMG_5382.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/okinawa/IMG_5395.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/okinawa/IMG_5502.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/okinawa/IMG_5698.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    ...
    <div class="col-sm-3 mt-3 mt-md-0">
        <div class="photo-container" style="height: 250px;">
            {% include figure.html path="assets/img/japan/okinawa/IMG_5625.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-3 mt-3 mt-md-0">
        <div class="photo-container" style="height: 250px;">
            {% include figure.html path="assets/img/japan/okinawa/IMG_5658.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="row mt-1">
...
<div class="row mt-3">
    <div class="col-sm-12 mt-3 mt-md-0">
        <div class="photo-container">
            {% include figure.html path="assets/img/japan/okinawa/IMG_5800.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption">
...
<div class="row mt-4">
    ...
    <div class="col-sm-6 mt-3 mt-md-0">
        <div class="photo-container">
            {% include figure.html path="assets/img/japan/okinawa/IMG_5949.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 mb-3">
    <div class="col-sm-5 mt-3 mt-md-0">
        <div class="photo-container" style="height: 400px;">
            {% include figure.html path="assets/img/japan/okinawa/IMG_5790.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-7 mt-3 mt-md-0">
        <div class="photo-container" style="height: 400px;">
...
<div class="row mt-4">
    <div class="col-sm-6 mt-3 mt-md-0">
        <div class="photo-container">
            {% include figure.html path="assets/img/japan/okinawa/IMG_6095.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <div class="photo-container" style="height: 340px;">
            {% include figure.html path="assets/img/japan/okinawa/IMG_6036.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container" style="height: 340px;">
            {% include figure.html path="assets/img/japan/okinawa/IMG_6035.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption">
