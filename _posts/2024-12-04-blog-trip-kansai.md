...
<div class="row mt-3">
    <div class="col-sm-11 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_6959.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
    Dotonbori lantern festival 道頓堀万灯祭.
</div>

<div class="col-sm-5" style="float: left;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kansai/IMG_6919.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.5rem; margin-bottom:0">
        Osprey became "Ospry" after a long trip:|
    </div>
</div>

It was already 12:30 am in Osaka when I arrived at Greenwood Hostel, which is located near the airport. (Ps. I took the flight from Fukuoka in Kyushu to here, you can see more about my Kyushu trip in my [last blog](https://bierone.github.io/blog/2024/blog-trip-kyushu)).  There are only a few hostels in Kansai that allow the late check-in, and Greenwood Hostel is one of them. Thankfully, the hostel is very clean and fully self-service. 
...
<div class="col-sm-5" style="float: right;margin-top: 2rem; ">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kansai/IMG_6920.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.5rem; margin-bottom:0">
        Me in Namba district, Osaka.
    </div>
</div>
<p style="margin-top: 2rem; margin-bottom: 10px;">
...
Thankfully, the weather was great, and I was lucky! I happened to catch the Tenjin Matsuri (天神祭), the annual festival of Shinsaibashi. There were boats cruising on the river, and they were also singing. The festival atmosphere was definitely in the air. For dinner, I had Okonomiyaki, which is essentially the same as the style from Hong Kong. Not really recommended:)
The area around Shinsaibashi is all commercial, and I visited Parco for some shopping. It felt quite similar to the area around Shibuya in Tokyo. So I didn't spend much time here.


<div class="row mt-3">
    <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_6938.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
    Tenjin Matsuri (天神祭), the annual festival of Shinsaibashi.
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7002.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_6977.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
     Me and Yupeng at [Left] a game center:) and [Right] Yasaka Shrine 八坂神社.
</div>
...
<div class="row mt-3">
    <div class="col-sm-5 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7008.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm-5 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_6767.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom:1rem">
    Me and Yupeng singing karaoke at the izakaya, Tsutenkaku shopping district.
</div>


**[Osaka Memory-C (Revisit Osaka)] Memorable encounter with a group of chinese students** 

[//]: # (除了这一次的背包旅行之外，我还想记录一下，旅行结束时，在大阪认识到的另外的中国学生。其实，刚从九州过来关西，突然的旅行风格变化让我感到很不适应。因为大阪有太多的游客，一路上遇到了更多中国人。和陌生人交流的风格一下子变成了探讨你的学校，专业，职业，国家的政策好与坏。这样的话题，让我感到有点无趣。)
[//]: # (但是这一次，我见识到了不一样的年轻人的色彩。他们有礼貌，还充满着敢想敢做的青春活力。我和他们恰巧偶遇在一个民宿，当天我们都要离开大阪。他们出发去东京，而我沿着相反方向走。在旅店check out之后，我们开始聊天，还一起玩桌游。非常有意思的时刻，让我们都不想离开。下午我送他们到地铁站，本来他们预计的下午两点坐新干线去东京。但是我们聊的太开心了，一直拖到了我们吃完晚饭，快六点他们才出发：）而且我们一直在地铁站前站着聊天，却一点也不累，只能感叹时间太短了。经过这件事情，也让我意识到了我自己对中国学生的刻板印象。对此感到很抱歉。下面是我们的合适，希望下次还能再见。)
...
<div class="row mt-3">
        <div class="col-sm-10 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_8423.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom:0.8rem">
    Me and Yuming, and Tian.
</div>

<div class="col-sm-4" style="float: left;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kansai/IMG_8420.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.5rem; margin-bottom:0">
        Board game together!
    </div>
...
<div class="row mt-3">
        <div class="col-sm-11 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7110.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom:0.8rem">
    Beautiful view from Wakakusa Hill 若草山.
</div>
...
<div class="col-sm-7 mt-3" style="float: left;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kansai/IMG_7159.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.8rem; margin-bottom:-0.5rem">
        Sat on the Wakakusa hill till evening.
    </div>
</div>
...
I discovered that you can feed the deer by picking leaves from the trees, so there’s no need to buy deer crackers. I took some photos and videos with the deer and wandered around the park. Eventually, I made my way to Wakakusa Hill (若草山), which is like a small hillside, though there were quite a few tourists taking photos there.
I climbed to the top of the hill and took some photos of the view. It was a bit tiring, but the view was worth it. I could see the whole of Nara city from the top of the hill.
...
<div class="row mt-3">
    <div class="col-sm-5 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7041.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm-7 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container mt-1">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7047.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption"  style="margin-top: 0">
    [Left] Feeding leaves to dear. [Right] Me and an old deer.
</div>
...
<div class="col-sm-6 mt-2" style="float: left;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kansai/IMG_7216.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
...
<div class="row mt-4">
    <div class="col-sm-4 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7226.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm-8 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container ">
        {% include figure.liquid path="assets/img/japan/kansai/dji_zhihao.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem">
    [Left] Deers were looking for food everywhere:) [Right] Me and Zhihao. 
</div>
...
<div class="row mt-3">
    <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/DJI_View_Kyoto.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
    Kyoto under the embrace of history and culture.
</div>


<div class="col-sm-8 " style="float: left;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kansai/IMG_7321.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
    Sannen-zaka & Ninen-zaka 三年坂二年坂 on the way to Kiyomizu-dera 清水寺. 
</div>
</div>
...
<div class="col-sm-8 mt-2" style="float: right;">
    <div class="photo-container" >
    {% include figure.liquid path="assets/img/japan/kansai/IMG_7325.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
    Me at Kiyomizu-dera 清水寺. 
</div>
</div>
...
After a short rest at Kamo River 鴨川, I headed to Hanami-koji 花見小路, a famous street in Gion. However, it's too late, and most of the shops were closed. I have to walk a long way back to the hostel. This let me feel
pretty exhausted, especially since I was carrying a lot of things and such a busy day. But I still enjoyed it, as Kyoto is so different from other cities in Japan. It has a unique atmosphere and is full of history and culture.
...
<div class="row mt-4">
    <div class="col-sm-6 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7408.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm-6" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container ">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7421.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container ">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7370.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem">
    [Left] Beautiful view of Kamo river 鴨川. Many people (includes me) sat along the riverbank to relax and enjoy Kyoto's scenery. <br>[Upper Right] Gion Matsuri 祇园祭 with lined lanterns and painted mythical creatures. [Lower Right] Chion-in 知恩院.
</div>
...
<div class="col-sm-10" style="float: right;">
    <div class="row">
        <div class="col-sm-6 mt-md-0" style="margin-left: 0; margin-right: -1rem">
            <div class="photo-container" style="height: 280px" >
            {% include figure.liquid path="assets/img/japan/kansai/IMG_7433.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
        <div class="col-sm-6 mt-md-0" style="margin-left: auto; margin-right: auto">
            <div class="photo-container" style="height: 280px" >
            {% include figure.liquid path="assets/img/japan/kansai/IMG_7447.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
    </div>
    <div class="caption"  style="margin-top: 0.3rem; margin-bottom: 0">
        [Left] Route to Arashiyama 嵐山. [Right] Lotus behind 御髮神社.
    </div>
</div>
...
<div class="col-sm-5 " style="float: right;">
    <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7454.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
    Bamboo forest in Arashiyama 嵐山.
</div>
</div>
...
<div class="row mt-3">
    <div class="col-sm-10 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7511.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
    Me and Kim drank too much that night.
</div>
...
<div class="col-sm-5 " style="float: left;">
    <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7498.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
    Rest at Kamo River 鴨川.
</div>
</div>
...
<div class="row">
    <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7558.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
    海の京都. The train to Amanohashidate 天橋立.
</div>
...
<div class="col-sm-6 " style="float: left;">
    <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7537.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
    Guesthouse at Maizuru.
</div>
</div>
Today, I left Kyoto and headed to Maizuru 舞鶴. For lunch, I stopped by a nearby restaurant, Kamo River Noodles 鴨川制面所. The food was quite good, with a tempura and cold noodle set.
In the afternoon, I started my journey to Maizuru, and after two and a half hours of traveling, I finally arrived:) 
...
<div class="col-sm-6 " style="float: right;">
    <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7550.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0.3rem">
    Screenshot of bouenkyou-san's post. 友達！
</div>
</div>
...
<div class="row mt-4">
    <div class="col-sm-6 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container" > 
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7545.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-6" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container mb-3" style="height: 240px">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7548.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container " style="height: 240px">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7546.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem">
    [Left] 若の汤; [Upper Right] Delicious 海鲜丼! [Lower Right] Very good restaurant at Maizuru!
</div>
...
<div class="row mt-3">
        <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7642.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom:1.2rem">
    Beautiful view of Amanohashidate (from Matsuyama Park).
</div>


<div class="col-sm-5 " style="float: right;">
    <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7553.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0.5rem">
    海の京都 Train ticket to Amanohashidate.
</div>
</div>
...
<div class="col-sm-6 " style="float: left;">
    <div class="photo-container" >
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7598.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
    Me and my bike at Amanohashidate 天橋立.
</div>
</div>
Upon arriving at Amanohashidate, I rented a bike and started riding across the sea. The sea here had a similar feel to Okinawa—extremely beautiful and clear. I sat by the shore and ate a sandwich, played with the water, then continued biking to the other side, where Matsuyama Park is located.
Due to time constraints, I took the cable car up and down the mountain to catch a full view of Amanohashidate’s stunning landscape.
Although there’s some controversy, it was still incredibly beautiful. Not everywhere do you see a large landmass stretching across the sea — so quiet and harmonious. I heard that if you look at Amanohashidate upside down from the mountain, you’ll see a different kind of view. I tried it out — didn't quite work :) but I still took some photos.
Since I had a meeting in the evening, I had to head to McDonald's for WIFI. 


<div class="row mt-4">
    <div class="col-sm-7 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container ">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7618.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-5 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7665.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem">
    [Left] Lie! There is no difference when you look at Amanohashidate 天橋立 upside down. [Right] Anime characters everywhere.
</div>
...
<div class="row mt-4">
    <div class="col-sm-6 mt-md-0" style="display:block; margin-left:auto; margin-right:0">
        <div class="photo-container " style="height: 480px">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7675.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-5" style="display:block; margin-left:0; margin-right:auto">
        <div class="photo-container mb-2" style="height: 240px">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7680.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container " style="height: 240px">
        {% include figure.liquid path="assets/img/japan/kansai/IMG_7687.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption"  style="margin-top: 0.2rem">
    [Left] Heading to the ferry to Hokkaido 北海道. I just bought a bag of food and drinks for the one-day ferry trip; <br> [Upper Right] The ferry ticket; [Lower Right] My bed on the ferry. 
</div>