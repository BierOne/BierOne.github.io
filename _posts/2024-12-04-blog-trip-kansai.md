...
<div class="row mt-3">
    <div class="col-sm-11 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_6959.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="col-sm-5" style="float: left;">
    ...
    {% include figure.html path="assets/img/japan/kansai/IMG_6919.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
...
<div class="col-sm-5" style="float: right;margin-top: 2rem; ">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kansai/IMG_6920.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.5rem; margin-bottom:0">
...
<div class="row mt-3">
    <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_6938.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kansai/IMG_7002.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/japan/kansai/IMG_6977.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm-5 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7008.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
        <div class="col-sm-5 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_6767.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
        ...
        {% include figure.html path="assets/img/japan/kansai/IMG_8423.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom:0.8rem">
...
<div class="col-sm-4" style="float: left;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kansai/IMG_8420.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
    <div class="caption" style="margin-top: -0.5rem; margin-bottom:0">
        Board game together!
    </div>
...
<div class="row mt-3">
        <div class="col-sm-11 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7110.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom:0.8rem">
...
<div class="col-sm-7 mt-3" style="float: left;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kansai/IMG_7159.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
...
<div class="row mt-3">
    <div class="col-sm-5 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7041.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm-7 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container mt-1">
        {% include figure.html path="assets/img/japan/kansai/IMG_7047.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="col-sm-6 mt-2" style="float: left;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kansai/IMG_7216.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
</div>
...
<div class="row mt-4">
    <div class="col-sm-4 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7226.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm-8 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container ">
        {% include figure.html path="assets/img/japan/kansai/dji_zhihao.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/DJI_View_Kyoto.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
...
<div class="col-sm-8 " style="float: left;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kansai/IMG_7321.jpeg" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
...
<div class="col-sm-8 mt-2" style="float: right;">
    <div class="photo-container" >
    {% include figure.html path="assets/img/japan/kansai/IMG_7325.gif" class="img-fluid rounded z-depth-1 " zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
...
<div class="row mt-4">
    <div class="col-sm-6 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7408.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm-6" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container ">
        {% include figure.html path="assets/img/japan/kansai/IMG_7421.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container ">
        {% include figure.html path="assets/img/japan/kansai/IMG_7370.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem">
...
<div class="col-sm-10" style="float: right;">
    <div class="row">
        <div class="col-sm-6 mt-md-0" style="margin-left: 0; margin-right: -1rem">
            ...
            {% include figure.html path="assets/img/japan/kansai/IMG_7433.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
        <div class="col-sm-6 mt-md-0" style="margin-left: auto; margin-right: auto">
            <div class="photo-container" style="height: 280px" >
            {% include figure.html path="assets/img/japan/kansai/IMG_7447.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
            </div>
        </div>
    </div>
...
<div class="col-sm-5 " style="float: right;">
    <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/IMG_7454.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
...
<div class="row mt-3">
    <div class="col-sm-10 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/IMG_7511.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
...
<div class="col-sm-5 " style="float: left;">
    <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/IMG_7498.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
...
<div class="row">
    <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7558.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption" style="margin-top: -0.5rem; margin-bottom:0.8rem">
...
<div class="col-sm-6 " style="float: left;">
    <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/IMG_7537.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
...
<div class="col-sm-6 " style="float: right;">
    <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/IMG_7550.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
...
<div class="row mt-4">
    <div class="col-sm-6 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container" > 
        {% include figure.html path="assets/img/japan/kansai/IMG_7545.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-6" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container mb-3" style="height: 240px">
        {% include figure.html path="assets/img/japan/kansai/IMG_7548.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container " style="height: 240px">
        {% include figure.html path="assets/img/japan/kansai/IMG_7546.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem">
...
<div class="row mt-3">
        <div class="col-sm-12 mt-3 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7642.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="col-sm-5 " style="float: right;">
    <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/IMG_7553.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
...
<div class="col-sm-6 " style="float: left;">
    <div class="photo-container" >
        {% include figure.html path="assets/img/japan/kansai/IMG_7598.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
<div class="caption"  style="margin-top: -0.5rem; margin-bottom: 0">
...
<div class="row mt-4">
    <div class="col-sm-7 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        <div class="photo-container ">
        {% include figure.html path="assets/img/japan/kansai/IMG_7618.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-5 mt-md-0" style="display:block; margin-left:auto; margin-right:auto">
        {% include figure.html path="assets/img/japan/kansai/IMG_7665.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption"  style="margin-top: -0.5rem">
...
<div class="row mt-4">
    <div class="col-sm-6 mt-md-0" style="display:block; margin-left:auto; margin-right:0">
        ...
        {% include figure.html path="assets/img/japan/kansai/IMG_7675.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
    <div class="col-sm-5" style="display:block; margin-left:0; margin-right:auto">
        <div class="photo-container mb-2" style="height: 240px">
        {% include figure.html path="assets/img/japan/kansai/IMG_7680.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
        <div class="photo-container " style="height: 240px">
        {% include figure.html path="assets/img/japan/kansai/IMG_7687.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </div>
    </div>
</div>
